...
/datum/game_mode/proc/send_intercept()
	...
	priority_announce("A summary has been copied and printed to all communications consoles.", "Enemy communication intercepted. Alert status elevated.", 'sound/ai/intercept.ogg')

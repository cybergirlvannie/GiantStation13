...
/obj/item/pen/blue
	desc = "It's a blue ink pen, modified for use with both paper and GATO-brand Digital-Readpads™!"
	icon_state = "pen_blue"
	colour = "blue"

/obj/item/pen/red
	desc = "It's a red ink pen, modified for use with both paper and GATO-brand Digital-Readpads™!"
	icon_state = "pen_red"
	colour = "red"
...
/obj/item/pen/fourcolor
	desc = "It's a fancy four-color ink pen, set to black. Modified to be compatible with GATO-brand Digital-Readpads™"
	name = "four-color pen"
	colour = "black"

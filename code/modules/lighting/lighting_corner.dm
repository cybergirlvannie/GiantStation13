...
/datum/lighting_corner/Destroy(var/force)
	...
	stack_trace("Ok, Look, I need you to find whatever fucker decided to call qdel on a fucking lighting corner, then whap them with a clue by four. Thanks. Send them my regards by the way.")
